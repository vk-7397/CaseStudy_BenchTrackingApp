...
public class GlobalExceptionHandler {
   ...
   @ExceptionHandler(value=ProjectDataAlreadyExistsException.class)
	public ResponseEntity<String> ProjectDataAlreadyExistsException(ProjectDataAlreadyExistsException st)
	{
